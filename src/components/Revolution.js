...
export default function Revolution(props) {
    ...
    return (
        <Grid container direction='column'>
            ...
            <Grid item container direction='row' className={classes.rowContainer} alignItems='center'>
                <Grid item lg> 
                    <img src={vision} alt='mountain binoculars' style={{maxWidth:'40em', marginRight:'5em'}}  />
                </Grid>
        ...
        {/*mockUp  */}
         ...
         <Grid item container direction='row' className={classes.rowContainer} style={{backgroundColor: '#39B54A', height:'90em'}}>
            ...
            {/* review */}
            <Grid item container direction='row' className={classes.rowContainer} style={{backgroundColor: '#39854A', height:'90em'}}>
             <Grid item container direction='column' lg>
                 <Grid item>
                     <Typography variant='h4' gutterBottom style={{color:'#000', marginTop:'5em'}} >Review</Typography>
                 </Grid>
          ...
          <Grid item container direction='row' className={classes.rowContainer} style={{backgroundColor: '#8E45CE', height:'90em'}}>
             ...
             <Grid item lg style={{alignSelf: 'center'}}>
                 <img src={maintain} alt='wrench with bolts'  />
             </Grid>
         </Grid>
