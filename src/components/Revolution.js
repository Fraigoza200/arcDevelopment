    ...
    return (
        <Grid container direction='column'>
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row'} className={classes.rowContainer} alignItems='center' style={{marginTop: '5em'}}>
                <Grid item lg> 
                    <img src={vision}  alt='mountain binoculars' style={{maxWidth: matchesSM ? 300 : '40em', marginRight:matchesMD ? 0 :'5em', marginBottom: matchesMD ? '5em' : 0}}  />
                </Grid>
        ...
        {/*mockUp  */}
         <Grid item container direction={matchesMD ? 'column' :'row'}  className={classes.rowContainer} style={{backgroundColor: '#FF7373', height:'90em'}}>
             ...
             <Grid item lg style={{alignSelf: 'center'}}>
                 <img src={mockup} alt='basic website design' style={{maxWidth: 1000}} width='100%'/>
             </Grid>
         </Grid>
         ...
         <Grid item container direction={matchesMD ? 'column' :'row'}  className={classes.rowContainer} style={{backgroundColor: '#39B54A', height:'90em'}}>
            ...
            {/* review */}
            <Grid item container direction={matchesMD ? 'column' :'row'}  className={classes.rowContainer} style={{backgroundColor: '#39854A', height:'90em'}}>
             <Grid item container alignItems={matchesMD ? 'center' : undefined} direction='column' lg>
                 <Grid item>
                     <Typography align={matchesMD ? 'center' : undefined} variant='h4' gutterBottom style={{color:'#000', marginTop:'5em'}} >Review</Typography>
                 </Grid>
             ...
             <Grid item lg style={{alignSelf: 'center'}}>
                 <img src={build} alt='building construction' style={{maxWidth: matchesMD ? 700 : 1000}} width='100%' />
             </Grid>
         </Grid>
          ...
          <Grid item container direction={matchesMD ? 'column' :'row'}  className={classes.rowContainer} style={{backgroundColor: '#8E45CE', height:'90em'}}>
             ...
             <Grid item lg style={{alignSelf: 'center'}}>
                 <img src={maintain} alt='wrench with bolts' style={{maxWidth: 500}} width='100%'/>
             </Grid>
         </Grid>
