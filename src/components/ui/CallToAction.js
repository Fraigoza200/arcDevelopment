      ...
      <Grid container style={{height: '60em'}} alignItems="center" justify={matchesSM ? "center":"space-between"}  className={classes.background} direction={matchesSM ? 'column': 'row'}>
        <Grid item style={{ marginLeft: matchesSM ? 0 :'5em,', textAlign: matchesSM ? 'center': 'inherit'}}>
            <Grid container direction="column">
                <Grid item>
                    <Typography variant="h2" style={{marginLeft: matchesSM ? 0: '2em'}}>Simple SoftWare.<br /> Revolutionary Results.</Typography>
                    <Typography variant="subtitle2" style={{fontSize: '1.5rem', marginLeft: matchesSM ? 0: '4em'}}>Take advantage of the 21st Century.</Typography>
