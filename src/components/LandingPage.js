        ...
        <Grid item>
            ...
            <Grid container direction="row" style={{height: '80em'}} alignItems="center" className={classes.infoBackground}>
                ...
                <Grid item sm style={{marginLeft: matchesXS ? 0 : matchesSM ? '2em' : '5em'}}>
                    <Grid container direction="column" style={{marginBottom: matchesXS ? '10em': 0}}>
                        ...
                        <Grid item>
                        <Button component={Link} to='/about' style={{color:'white', borderColor: 'white'}} variant ="outlined" className={classes.learnButton} onClick={() => props.setValue(3)}>
                        <span style={{marginRight:10}}> Learn More </span>
            ...
            <Grid item sm style={{ marginRight: matchesXS ? 0 : matchesSM ? '2em' : '5em', textAlign: matchesXS ? 'center':'right'}}>
                    <Grid container direction="column">
                        ...
                        <Grid item>
                        <Button component={Link} to='/contact' style={{color:'white', borderColor: 'white'}} variant ="outlined" className={classes.learnButton} onClick={() => props.setValue(4)}>
                        <span style={{marginRight:10}}> Learn More </span>
                        <ButtonArrow width={10} height={10} fill="white"/>
                        </Button>
                        </Grid>
